    ...
    this.update = function() {
        ...
        mPlayers.forEach(function(player) {
            ...
            if (player.isMovingLeft){
                ...
                player.mIsFacingRight = false;
                console.log("a la esquerraaa");
            }else if(player.isMovingRight){
                player.sprite.body.velocity.x = 490;
                player.sprite.animations.play('right');
                player.mIsFacingRight = true;
                console.log("a la dretaa");
            }else{
                onNoDirectionPressed(player);
            }
            ...
            if (!player.sprite.body.touching.down){
                if (player.mIsFacingRight){
                    player.sprite.animations.play('jumpRight');
                }else{
                    player.sprite.animations.play('jumpLeft');
                }
            }
        });
    };
       ...
       createPlayerSprite();
        if (mPlayers != null){
            ...
            if (mPlayers.length == 2) {
                mPlayers[mPlayers.length-1].sprite.body.position.x = 740;
